...
IMAGE_REPOSITORY_URL = registry.wanzhixin.net/fanli/goods
...
COMMAND_ROOT = dev-gitlab.wanxingrowth.com/fanli/goods/v2/cmd
...
run_service_local: build_service_local
	# Use ./config/example.json copy to ./config/dev.yaml when first time debug
